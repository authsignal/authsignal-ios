...
class PasskeyAPIClient: BaseAPIClient {
  func registrationOptions(
    ...
    let url = "\(baseURL)/v1/client/user-authenticators/passkey/registration-options"
  ...
  func authenticationOptions(
    ...
    let url = "\(baseURL)/v1/client/user-authenticators/passkey/authentication-options"
  ...
  func addAuthenticator(
    ...
    let url = "\(baseURL)/v1/client/user-authenticators/passkey"
  ...
  func verify(
    ...
    let url = "\(baseURL)/v1/client/verify/passkey"
